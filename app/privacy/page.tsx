  ...
  return (
    <main>
      ...
      <section className="container-page max-w-3xl space-y-6 leading-8 text-slate-300">
        ...
        <p>BEYBUKU is a fan encyclopedia. We aim to collect only the information needed to operate the website, improve content, respond to messages, and maintain a good user experience.</p>
        <h2 className="text-2xl font-black text-white">Information We May Collect</h2>
        <p>If you contact BEYBUKU, we may receive the name, email address, and message content you choose to provide. We use that information only to review your request, respond to you, or improve site content.</p>
        <h2 className="text-2xl font-black text-white">Analytics and Advertising</h2>
        <p>BEYBUKU may use analytics or advertising services to understand traffic and support the site. If Google AdSense is enabled, Google and its partners may use cookies or similar technologies to serve and measure ads according to their own policies.</p>
