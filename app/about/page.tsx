      ...
      <section className="container-page grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4 leading-8 text-slate-300">
            <p>BeyVerse is built to help fans understand Beyblade releases, parts, combo ideas, anime context, and competitive testing notes in one organized place.</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 leading-8 text-slate-300">
            ...
            <p>BeyVerse is a fan-made project and is not affiliated with, sponsored by, or endorsed by the official Beyblade rights holders.</p>
          </CardContent>
        </Card>
      </section>
    </main>
