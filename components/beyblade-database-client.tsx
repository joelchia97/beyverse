...
const copy = {
  en: {
    ...
    releaseLabel: "Release", upcoming: "Announced", estimated: "estimated", unverified: "unverified", bestUse: "Best use", beginner: "Beginner", competitive: "Competitive",
  ...
  zh: {
    ...
    releaseLabel: "版本", upcoming: "即将推出", estimated: "估算", unverified: "未核实", bestUse: "适合用途", beginner: "新手", competitive: "竞技",
  ...
  ms: {
    ...
    releaseLabel: "Keluaran", upcoming: "Diumumkan", estimated: "anggaran", unverified: "belum disahkan", bestUse: "Kegunaan terbaik", beginner: "Pemula", competitive: "Kompetitif",
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {visibleItems.map((item) => (
            <EntityCard
              ...
              meta={`${cleanSeries(item.series)} / ${text.types[item.type]} / ${formatWeight(item, text)} / ${item.release_date}${isUpcoming(item.release_date) ? ` / ${text.upcoming}` : ""}`}
            ...
            <tbody className="divide-y divide-slate-800">
              {filtered.map((item) => (
                <tr key={item.id} className="hover:bg-slate-900/70">
                  ...
                  <td className="whitespace-nowrap px-4 py-3 text-slate-300">{formatWeight(item, text)}</td>
